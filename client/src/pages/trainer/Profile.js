...
//   const openEditModal = () => {
//     const expertiseValue = Array.isArray(
//       profile.expertise
//     )
//       ? profile.expertise.join(", ")
//       : profile.expertise || "";
...
//       formData.append(
//         "experienceYears",
//         Number(editData.experienceYears) || 0
//       );
...
//         `${API_BASE_URL}/api/trainer/profile`,
//         formData,
//         config
//       );
...
//                     <p>
//                       {profile.bio ||
//                         "Click Edit to add your professional summary."}
//                     </p>
//                   </section>
...
//                       <button
//                         className={`status-pill-btn ${profile.availability}`}
//                       >
//                         <span className="status-dot"></span>
        ...
        if (trainerId) {
          try {
            const reviewRes = await axios.get(
              `${API_BASE_URL}/api/reviews/${trainerId}`
            );
